...
#This test makes sure that float return true when compared, because of the
#rounding errors that can happen. This delta of the difference should be smaller
